...
echo "🔍 QUANTUM RTL STATUS CHECK FOR PSYCHOLOGY-IN-UX.HTML 🔍"
echo "====================================================="
...
if grep -q 'lang="he" dir="rtl"' psychology-in-ux.html; then
...
backup_count=$(ls -la psychology-in-ux.html.bak* 2>/dev/null | wc -l)
...
if grep -q 'quantum-rtl.css' psychology-in-ux.html && grep -q 'quantum-rtl.js' psychology-in-ux.html; then
  echo -e "${GREEN}PASS${NC}"
else
...
zone_count=$(grep -o 'class="quantum-rtl-zone"' psychology-in-ux.html | wc -l)
...
if grep -q '"inLanguage":"he_IL"' psychology-in-ux.html && grep -q '"inLanguage":"he-IL"' psychology-in-ux.html; then
  echo -e "${GREEN}PASS${NC}"
else
...
echo "Run: firebase deploy --only hosting:psychology-in-ux.html"
echo "Expected Live URL: https://nivaro-51.web.app/psychology-in-ux.html"
echo "====================================================="