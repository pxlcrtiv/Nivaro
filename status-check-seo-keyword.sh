...
# For: seo-keyword-research-guide.html
...
FILE="seo-keyword-research-guide.html"
ALL_PASSED=true
...
echo -e "Run: ${YELLOW}firebase deploy --only hosting:seo-keyword-research-guide.html${NC}"
echo -e "Expected live URL: ${YELLOW}https://nivaro-51.web.app/seo-keyword-research-guide.html${NC}\n"